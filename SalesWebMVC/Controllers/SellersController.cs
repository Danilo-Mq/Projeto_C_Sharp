...
using SalesWebMvc.Models.View_Models;
...
{
    public class SellersController : Controller// Para entender como funciona os Controllers, reveja a aula 262 minuto 6:56
    {
